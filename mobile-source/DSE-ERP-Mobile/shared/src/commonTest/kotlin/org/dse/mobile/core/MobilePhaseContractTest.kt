...
class MobilePhaseContractTest{
 ...
 @Test fun parityMobileVersionPinsLiveServerBaseline(){assertEquals("1.2.13",MobileBuildInfo.MOBILE_VERSION_NAME);assertEquals("1.2.13-V10.0.16-ANDROID",MobileBuildInfo.MOBILE_VERSION);assertEquals("10.0.16",MobileBuildInfo.SERVER_BASELINE);assertEquals("10.0.1",MobileBuildInfo.MINIMUM_COMPATIBLE_SERVER_VERSION);assertEquals("server-10.0.16-compatible-v5",MobileBuildInfo.API_CONTRACT_VERSION);assertEquals("1.2.3",MobileBuildInfo.MINIMUM_SUPPORTED_MOBILE_VERSION)}
